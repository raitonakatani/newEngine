...
namespace nsK2EngineLow
{
    ...
    public:
        ...
        struct Light
        {
            std::array<DirectionalLight, MAX_DIRECTIONAL_LIGHT> directionalLight; // ディレクションライト
   ...
   /// <param name="rc"></param>
    ...
    private:
        ...
        shadow::ShadowMapRender m_shadowMapRenders[MAX_DIRECTIONAL_LIGHT];	//シャドウマップへの描画処理
